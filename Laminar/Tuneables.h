...
constexpr int PAWNHIST_BONUS_BASE = 140;
constexpr int PAWNHIST_BONUS_MULT = 420;
constexpr int PAWNHIST_BONUS_MAX = 2400;

constexpr int PAWNHIST_MALUS_BASE = 140;
constexpr int PAWNHIST_MALUS_MULT = 420;
constexpr int PAWNHIST_MALUS_MAX = 2400;
...
constexpr int MINOR_CORRHIST_MULTIPLIER = 150;
